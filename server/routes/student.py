...
@router.post("/", dependencies=[Depends(JWTBearer())], response_description="Student data added into the database")
...
@router.get("/", dependencies=[Depends(JWTBearer())], response_description="Students retrieved")
